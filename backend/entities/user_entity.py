...
# from .group_user_table import group_user_table
...
class UserEntity(EntityBase):
    ...
    groups: Mapped[list["GroupUserEntity"]] = relationship(back_populates="users")
    ...
    # groups: Mapped[list["GroupEntity"]] = relationship(
    #     "GroupEntity", secondary=group_members, back_populates="participants"
    # )
